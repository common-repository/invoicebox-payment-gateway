...
class GetOrdersTest extends TestCase
{
    ...
    public function testGetOrder(){
        $result = $this->IB->Order()->getOrder($this->orderId);
        $this->assertInstanceOf(\Invoicebox\Contracts\Models\OrderResponseInterface::class, $result );
    }

    public function testGetOrders(){
        $result = $this->IB->Order()->getOrders(["status" => "expired"]);
        $this->assertInstanceOf(\Invoicebox\Contracts\Models\OrdersResponseInterface::class, $result );
    }
